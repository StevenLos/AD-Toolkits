...
function Convert-SvgToPng {
    ...
    $userDataDir = Join-Path ([System.IO.Path]::GetTempPath()) ("timeserver-render-" + [System.Guid]::NewGuid().ToString("N"))
...
if ($RendererPath) {
    ...
    $renderer = Join-Path $PSScriptRoot "Convert-TimeServerInventoryToSvg.py"
}
...
$detailsCsv = Join-Path $outputDirectory.FullName "$safeName.time-relationship-details.csv"
