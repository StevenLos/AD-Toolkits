...
function Convert-SvgToPng {
    ...
    $userDataDir = Join-Path ([System.IO.Path]::GetTempPath()) ("adforest-render-" + [System.Guid]::NewGuid().ToString("N"))
...
if ($RendererPath) {
    ...
    $renderer = Join-Path $PSScriptRoot "Convert-ADForestConfigurationInventoryToSvg.py"
}
